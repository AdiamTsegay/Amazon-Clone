          ...
          <div className="row">
            ...
            <div className="col">
              ...
              <ul>
                ...
                <li>Host an Amazon-clone Hub</li>
                <li>See More Make Money with Us</li>
              </ul>
            </div>
            <div className="col">
              <p>
                <strong>Amazon-clone Payment Products</strong>
              </p>
              <ul>
            ...
            <div className="col">
              ...
              <ul>
                <li>Amazon-clone and COVID_19</li>

                <li>Your Account</li>
                <li>Your Orders</li>
                <li>Shopping Rates & Policies</li>
                <li>Amazon-clone Prime</li>
              </ul>

              <div className="footer__bottom">
                Built by:<a href="https://www.Adiamdesta.com">Adiam Tsegay</a>
              </div>
            </div>
          </div>
        </div>
